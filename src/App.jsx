...
function App1() {
    ...
    useEffect(() => {
        getCurrent().then((value) => {
            ...
            if (editor == null) {
                editor = loadJSONEditor(value, (value) => {
                    console.log(value)
    ...
    return <div>
        ...
        <div style={{ textAlign: "center", marginTop: "15px" }}>
            <Space>
                ...
                <Button type="outline" icon={<IconClockCircle />} onClick={saveJSON}>保存</Button>
                ...
                <Button onClick={serialize} type="outline" icon={<IconAlignCenter />}>序列化</Button>
                <Button onClick={deserializeJSON} type="outline" icon={<IconAlignCenter />}>反序列化</Button>
            </Space>
        </div>
    </div>
}
